...
#define THREAD0_PRIORITY 5   // When using k_busy_wait use same priority of threads, lower number indicates higher priority thread.
...
K_THREAD_DEFINE(thread0_id,STACKSIZE,thread_func1,NULL,NULL,NULL,THREAD0_PRIORITY,0,0);
K_THREAD_DEFINE(thread1_id,STACKSIZE,thread_func2,NULL,NULL,NULL,THREAD1_PRIORITY,0,0);	
